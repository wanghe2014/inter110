						...
						<tr>
							...
							<td height="15" align="left" valign="top" class="12">
							 <table width="100%" height="20" border="0" cellpadding="0"cellspacing="0">
								<tr><td height="20"><div class="right_proaducts"><font color="red">注册信息:</font>
												<br />
											</div>
										<DIV class=padding>
										<DIV id=middlebody>
...
<tr>
    ...
    <td class="item" width="41%"><div align="right">用户名:</div></td>
    <td  width="7%"></td>
    <td width="52%">
...
<tr>
    ...
    <td class="item"><div align="right">密码: </div></td>
     <td  width="7%"></td>
...
<tr>
    ...
    <td class="item"><div align="right">密码确认:</div></td>
     <td  width="7%"></td>
    <td>
...
<tr>
    ...
    <td class="item"><div align="right">公司名称:</div></td>
 <td  width="7%"></td>
    <td>
...
<tr>
    ...
    <td class="item"><div align="right">公司地址:</div></td>
 <td  width="7%"></td>
    <td>
...
<tr>
    ...
    <td class="item"><div align="right">国家:</div></td>
 <td  width="7%"></td>
    <td>
...
<tr>
    ...
    <td class="item"><div align="right">城市:</div></td>
 <td  width="7%"></td>
    <td>
...
<tr>
    ...
    <td class="item"><div align="right">工作:</div></td>
 <td  width="7%"></td>
    <td>
...
<tr>
    ...
    <td class="item"><div align="right">电话:</div></td>
 <td  width="7%"></td>
    <td>
