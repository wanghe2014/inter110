...
public class OrderDAO {
	...
	//查找注册用户的订单
	public List findOrderList(int uid)throws SQLException
	{
	...
	//查找所有订单
	public List findOrderAllList()throws SQLException
	{
		List list =new ArrayList();
		Connection con = DataAccess.getConnection();
		Statement st;
	...
	public List findOrderItem(int orderid)throws SQLException
	{
		List list =new ArrayList();
		Connection con = DataAccess.getConnection();
		Statement st;
